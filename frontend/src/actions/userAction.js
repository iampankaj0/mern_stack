...
// UPDATE PROFILE ACTION FUNCTION
...
// UPDATE PASSWORD ACTION FUNCTION
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const config = { headers: { "content-Type": "application/json" } };
    const { data } = await axios.post("/api/forgetPassword", { email }, config);
...
// GET ALL USERS LIST ACTION - ADMIN
